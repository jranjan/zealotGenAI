...
class LLMModelCatalog(Enum):
    """Supported LLM models with token limits"""
    ...
    @classmethod
    def from_string(cls, model_str: str) -> 'LLMModelCatalog':
        """Create LLMModelCatalog from string"""
        ...
        raise ValueError(f"Unknown LLM model: {model_str}")
